...
export default function Oasissportopia() {
    ...
    return (
        ...
        {/* block 1 start  */}
            <div className=" mt-10 lg:mt-20">
                <img src="./images/oasis/oasis1.png" alt="" className="w-full h-auto" />
            </div>
        {/* block 1 end */}
        ...
        {/* block 2 start  */}
            <div className="mt-10 lg:mt-20">
                ...
                <div className="mt-10 lg:mt-20">
                    <img src="./images/oasis/oasis2.png" alt="" className="w-full h-auto" />
                </div>
        ...
        <div className="mt-5 lg:mt-20 ">
            <p className="text-3xl mt-20 lg:mt-28 font-bold">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 mt-10 lg:mt-20 h-auto sm:h-auto md:h-auto  lg:h-[450px] xl:h-[550px] 2xl:h-[650px] ">
                <div className="relative hidden lg:block" >
                    <img src="./images/oasis/oasis3.png" className="absolute top-20 xl:top-28 2xl:top-32 left-0 w-[85%] h-auto" alt="" />
                </div>
                <div className="relative hidden lg:block" >
                    <img src="./images/oasis/oasis4.png" className="absolute bottom-44 xl:bottom-52 2xl:bottom-44 right-0 w-[85%] h-auto" alt="" />
                </div>
                <div className="relative block lg:hidden " >
                    <img src="./images/oasis/oasis3.png" className="w-full h-auto" alt="" />
                </div>
                <div className="relative block lg:hidden" >
                    <img src="./images/oasis/oasis4.png" className="w-full mt-10 h-auto" alt="" />
                </div>
