...
export default function Subhadental() {
    ...
    return (
        ...
        {/* block 1 start  */}
            <div className=" mt-10 lg:mt-20">
                <img src="./images/subha/subha1.png" alt="" className="w-full h-auto" />
            </div>
        {/* block 1 end */}
        ...
        {/* block 2 start  */}
            <div className="mt-10 lg:mt-20">
                ...
                <div className="mt-10 lg:mt-20">
                    <img src="./images/subha/subha2.png" alt="" className="w-full h-auto" />
                </div>
        ...
        <p className="text-3xl   font-bold">
                ...
                <img src="./images/subha/subha3.png" alt="" className=" mt-10 lg:mt-20 w-full h-auto" />
            </div>
            <p className="mt-10 text-3xl font-bold text-justify">
                Designing and developing a modern and minimal website, with multiple features, such as architectural virtual reality tours and animations, for a studio with high design expectations was a tremendously enjoyable experience for us.
            </p>
        ...
        {/* block 4 start */}
        <div className="mt-5 lg:mt-32 pb-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 mt-10 lg:mt-20 h-auto sm:h-auto md:h-auto  lg:h-[450px] xl:h-[550px] 2xl:h-[650px] ">
                <div className="relative hidden lg:block" >
                    <img src="./images/subha/subha4.png" className="absolute top-20 xl:top-28 2xl:top-32 left-0 w-[85%] h-auto" alt="" />
                </div>
                <div className="relative hidden lg:block" >
                    <img src="./images/subha/subha5.png" className="absolute bottom-44 xl:bottom-52 2xl:bottom-44 right-0 w-[85%] h-auto" alt="" />
                </div>
                <div className="relative block lg:hidden " >
                    <img src="./images/subha/subha4.png" className="w-full h-auto" alt="" />
                </div>
                <div className="relative block lg:hidden" >
                    <img src="./images/subha/subha5.png" className="w-full mt-10 h-auto" alt="" />
                </div>
